...
QString getCreditsHtml()
{
    ...
    //: %1 is the name of the launcher, determined at build time, e.g. "ALLauncher Developers"
    ...
    stream
        << "<p>And everyone else who <a href='https://github.com/ALLauncher/ALLauncher/graphs/contributors'>contributed</a>!</p>\n";
    stream << "<br />\n";
